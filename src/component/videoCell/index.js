...
export default class VideoCell extends Component {
  ...
  render() {
    ...
    const {title, cover, param, play, danmaku} = {};
    ...
    return (
      <TouchableHighlight
        ...
        onPress={this._goVideo}
        ref={k => (this.touch = k)}
        aid={param}>
        <View style={styles.cell}>
          <Image source={{uri: cover}} style={styles.pic} />
          <View style={{height: 38, overflow: 'hidden', padding: 5}}>
            <Text style={{fontSize: 13, color: '#333'}}>{title}</Text>
          </View>
          <View style={styles.content}>
            <View style={styles.part}>
              <Image
                source={require('../resource/icons/ic_info_views.png')}
                style={{width: 16, tintColor: '#aaa'}}
                resizeMode="contain"
              />
            ...
            <View style={styles.part}>
              <Image
                source={require('../resource/icons/ic_info_danmakus.png')}
                style={{width: 16, tintColor: '#aaa'}}
                resizeMode="contain"
              />
