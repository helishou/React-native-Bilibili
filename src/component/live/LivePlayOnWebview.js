...
const BASE_URL =
  'http://h.open.huajiao.com/l/index?&channelid=uclevel2&tag=live&uc_biz_str=S:custom|C:full_screen|M:true&liveid=';
  ...
  render() {
    ...
    return (
      <WebView
        ...
        injectedJavaScript={
          "$('#_live_video_msgbox,#dayRanks,._cell _cell_fol,#_header_follow_box,.menu-box,#_mic_box,._pep_coin,#_mini_dialog').remove();" +
