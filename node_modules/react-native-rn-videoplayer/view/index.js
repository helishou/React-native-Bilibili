            ...
            <View
                ...
                <View style={
                    ...
                    <View style={{ backgroundColor: "rgba(255,255,255,0.5)", height: 2, width: 100, marginLeft: 8 }}>
                        <Animated.View style={{ backgroundColor: props.color?props.color:"#ea7a99", width: brightnessWidth && brightnessWidth, zIndex: 99999, height: 2 }}></Animated.View>
                    </View>
                </View>
            </View>
        )
        ...
        return (
            <View
                ...
                <View style={{
                    ...
                    <View style={{ backgroundColor: "rgba(255,255,255,0.5)", height: 2, width: 100, marginLeft: 8 }}>
                        <Animated.View style={{ backgroundColor: props.color?props.color:"#ea7a99", width: soundWidth && soundWidth, zIndex: 99999, height: 2 }}></Animated.View>
                    </View>
                </View>
            </View>
        )
