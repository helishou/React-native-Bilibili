...
class VideoPlayer extends React.Component {
  ...
  constructor(props) {
    ...
    (this.dotX = new Animated.Value(0)),
      ...
      (this.state = {
        ...
        height: this.props.height ? this.props.height : height * 0.34, //原来为220
  ...
  setSmall = () => {
    ...
    this.setState(
      {
        width: width,
        height: this.props.height ? this.props.height : height * 0.34,
        statusBarH: 0, //
        smallP: true,
        showConts: false,
        showLockCont: false,
