...
class VideoPlayer extends React.Component {
  ...
  constructor(props) {
    ...
    (this.dotX = new Animated.Value(0)),
      ...
      (this.state = {
        ...
        showSpeedModal: false, //选择速度的弹框显示状态
        speed: 1,
      });
  ...
  componentDidMount() {
    ...
    if (this.props.autoPlay) {
      ...
      this.props.changeDanmuku &&
        this.props.changeDanmuku({
          clear: !this.props.clear,
          currentTime: this.nowCurrentTime,
        });
    }
      ...
      onPanResponderMove: (evt, gestureState) => {
        ...
        if (this.realMarginLeft > 0) {
          ...
          if (this.SpeedTipTimeRef) {
            ...
            console.log('我是拖动进度条');
            if (this.props.changeDanmuku) {
              console.log('我存在', this.props.clear);
              if (this.props.clear == 0) {
                console.log('我运行了');
                this.temp = 1;
                this.props.changeDanmuku({
      ...
      <>
        ...
        <View
          ...
          <Modal
            animationType="slide"
            transparent={true}
            visible={this.state.showSpeedModal}
            onRequestClose={() => {
              // Alert.alert('Modal has been closed.');
              this.setState({showSpeedModal: !this.state.showSpeedModal});
            }}>
            <View style={s.centeredView}>
              <View style={s.modalView}>
                <Text style={s.modalText}>选择速度</Text>
                {[0.25, 0.5, 0.75, 1.0, 1.25,1.5, 2.0, 2.5, 3.0].reduce(
                  (total, item) => {
                    ...
                    total.push(
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          this.setState({
                            showSpeedModal: !this.state.showSpeedModal,
                            speed: item,
                            videoRate: item,
                          });
                        }}>
                        <Text style={s.textStyle}>{this.toDecimal2(item)}</Text>
                      </TouchableOpacity>,
                    );
                    console.log(total);
                    return total;
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        <Text
                          ...
                          {this.toDecimal2(this.state.speed)}
                        </Text>
                      </TouchableOpacity>
                      {this.props.continuous && (
                        <TouchableOpacity
